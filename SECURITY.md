...
### Reporting security problems in the ORE mint contract

**DO NOT CREATE A GITHUB ISSUE** to report a security problem.

Instead please use this [Report a Vulnerability](https://github.com/regolith-labs/ore-mint/security/advisories/new) link.
